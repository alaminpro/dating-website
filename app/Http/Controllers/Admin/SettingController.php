...
class SettingController extends Controller
{
    ...
    public function saveSetting()
    {
        ...
        if ($validator->fails()) {
            ...
            Setting::where('meta', 'feature_upgrade')->update(['value' => $this->request->get('feature_upgrade')]);
            Setting::where('meta', 'default_coin')->update(['value' => $this->request->get('default_coin')]);
