...
<nav class="navbar  navbar-light bg-blue disp-none position-sticky" style="top:0"  id="profile-header-sm" >
  <!-- <div class="bg-blue"> -->
...
<!-- <a href="#" class="navbar-brand">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <div class="navbar-nav">
      ...
      <a class="{!! Illuminate\Support\Facades\Route::is('videos')?'active':'' !!} nav-item nav-link" href="{{route('videos')}}">Video Chat <i class="fas fa-video"  style="float: right;"></i></a>
