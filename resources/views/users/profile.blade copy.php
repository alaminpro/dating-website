...
?>
                <p class="page-title text-capitalize mb-1 clearfix pl-4">
                    Public Photos
                    <a class="float-right push-right"
                        href="{!! route('userphoto',['username'=>strtolower($user->username)]) !!}">View All</a>
                </p>
                <div class="page-title clearfix">
                    <div class="row users-photo mb-3 pl-3 mr-1">
...
?>
                        <div class="col-md-2 profile-ipad-img">
                            <div data-id="{!! $user->id !!}" data-url="{!! url($avatar) !!}"
                                class="photo-item-cover view-photo border"
...
?>
                        <div class="col-md-2 profile-ipad-img">
                            ...
                            <div data-id="{!! $photo->id !!}" data-url="{!! url($photo_file) !!}"
                                class="photo-item view-photo border"
                                style="background-image: url('{!! url($cover) !!}')">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="formUpload" action="{!! route('crop_upload_photo') !!}"
                                            ...
                                            <div class="form-group">
                                                <button id="upload-btn" class="btn btn-sm btn-primary btn-block"
