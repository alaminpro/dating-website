          ...
          <div class="col-md-8">
            ...
            if ($url2 == 'localhost') {
             ...
             ?>
              ...
              <div class="full_photo d-flex align-items-center"><img src="{!! url($photo_file) !!}"  ></div>
          </div>
                              ...
                              @endif
                                ...
                                <div class="d-flex justify-content-between align-items-center py-2">
                                    <div class="edit-option">
                                      <p class="p-0 m-0  details-hide">{{ trim($photo->description) }}</p>
                                      <div class="edit-description-option">
                                        <textarea name="description" cols=80 wrap="virtual" rows="2" class="edit-description"  data-photo-id="{{$photo->id}}">{{ trim($photo->description) }}</textarea>
                                      </div>
                                    </div>
                                    @if(auth()->check() && (auth()->user()->id == $user_id || auth()->user()->is_admin == 1))
                                    <div class="edit-delete-content-photo" id="delete_photo_show">
                                      <i class="fas fa-ellipsis-v" ></i>
                                      <div class="show-delete-btn">
                                          <span class="d-block edit-details"  >edit</span>
                                          <span class="d-block delete-photo" data-photo-id="{{$photo->id}}">delete</span>
                                      </div>
                                    </div>
                                    @endif
                                </div>
