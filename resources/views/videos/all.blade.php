  ...
  <script> 
     $(document).ready(function(){
      ...
      if($('.scroll-bar').length){
          $('.scroll-bar').mCustomScrollbar().mCustomScrollbar();
      }
      var params={};  
      var user_id;  
                      ...
                      if(res.status === 'success'){
                        ...
                        $.map( res.data, function(user) {  
                            $('<li id="video-'+user.id+'" data-id="'+user.id+'" class="video__list"></li>').html('<div>\
                                ...
                                <span>'+user.username+'</span> \
                              </div><div>' + (user.online ? '<div class="badge__video_online">Live</div> ' : '<div class="badge__video_offline">Away</div>') + '</div>').appendTo(searchData);
                        }) 
                      } 
                    },
                    complete: function(){
