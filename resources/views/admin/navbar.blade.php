    ...
    <div class="collapse navbar-collapse"  id="navbarCollapse">
        <div class="navbar-nav">
            @if(auth()->check())
                ...
                <a class="{!! Illuminate\Support\Facades\Route::is('admin_feature')?'active':'' !!} nav-item nav-link" href="{!! route('admin_feature') !!}">Features <i class="fas fa-grin-hearts float-right"  style="padding-left:22px; margin-right: 50px;"></i></a>
                <a class="{!! Illuminate\Support\Facades\Route::is('adminsetting')?'active':'' !!} nav-item nav-link" href="{!! route('adminsetting') !!}">Manage AD <i class="fas fa-ad float-right" style="padding-left:50px; margin-right: 50px;"></i></a>
