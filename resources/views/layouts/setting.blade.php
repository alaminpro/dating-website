                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="tab__main">
                            ...
                            <ul class="tab__items">
                                <li class="tab__item " data-tab="tab-1">Image Upload</li>
                                <li class="tab__item tab__active" data-tab="tab-2">Profile Details</li>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="tab__content current" id="tab-2">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control second bg-white" autocomplete="off"  name="username" id="register-setting-username">
